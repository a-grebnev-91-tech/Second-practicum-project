...
public class TaskAdapter extends TypeAdapter<Task> {
    ...
    private LocalDateTime readStartTime(JsonReader reader) throws IOException {
    ...
    private TaskStatus readStatus(JsonReader reader) throws IOException {
        String status = reader.nextString();
        return TaskStatus.valueOf(status);
    }

    private void writeTaskDateTime(JsonWriter writer, TaskDateTime taskDateTime) throws IOException {
